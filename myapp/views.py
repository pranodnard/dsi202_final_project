...
def slipper(request):
	...
	return render(request, 'myapp/slipper.html', context)
...
def HighTop(request):
	...
	brands = Brand.objects.all()
	cats = Product.objects.distinct().values('category__title')
	types = Product.objects.distinct().values('type')
	...
	return render(request, 'myapp/HighTop.html', context)
...
def LowTop(request):
	...
	return render(request, 'myapp/LowTop.html', context)
...
def type_list(request,Type_id):
	...
	return render(request, 'myapp/Type_list.html', {'data':data,'Type':Type,'brands':brands})
